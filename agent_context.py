...
БЛИЖНИЙ ВОСТОК:
- Конфликты (Израиль-Палестина, Иран, Ливан, Йемен) и их эскалация/деэскалация
- Влияние на цены нефти и энергоносителей
- Последствия для ЕС и Чехии (энергия, миграция, безопасность)
- Геополитические альянсы и их сдвиги
...
{{
  ...
  "middle_east_context": {{
    "conflicts": "Текущее состояние конфликтов (Израиль, Иран, Йемен и др.)",
    "oil_energy_impact": "Влияние на цены нефти и энергоносители",
    "eu_impact": "Последствия для ЕС и Чехии",
    "outlook": "Краткосрочный прогноз (эскалация/деэскалация)"
  }}
}}"""
